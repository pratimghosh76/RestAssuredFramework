...
public class TestCase6 {
    ...
    public void setup () throws InterruptedException{
       ...
       res = Utils.getResponseSearchAnyText("XYZ"); //Get response
     ...
     ValidateSearch (jp,"XYZ"); /// this is to validate positive search
     
     System.out.println("*******************Ending Test Case 6***********************");
    }
    ...
    public void ValidateSearch (JsonPath jp,String CountryCode) {
    	...
    	for(int i=0; i <htm.getCountryDetails(jp).size(); i++ ) {
            ...
            if (Message.contains(NegativeMessage)) {
            	 System.out.println("Search by Country by Apha Numeric 2 or 3 or CountryName Negative Testcase Passed and the message is :" + jp.get("RestResponse.messages[" + i + "]"));
