...
public class TestCase2 {
    ...
    public void setup () throws InterruptedException{
       ...
       res = Utils.getResponseSearchCountry("AF"); //Get response
  ...
  /*  private void printTitlePubDateDuration (JsonPath jp) {
    ...
    public void ValidateSearch (JsonPath jp,String CountryCode) {
            ...
            if (Message.contains(TobeSearched)) {
            	 System.out.println("Serach by country code Testcase Passed and the value is :" + jp.get("RestResponse.messages[" + i + "]"));
