...
public class TestCase4 {
    ...
    public void setup () throws InterruptedException{
       ...
       res = Utils.getResponseSearchCountry3Character("XYZ"); //Get response
...
*/
    ...
    public void ValidateSearch (JsonPath jp,String CountryCode) {
            ...
            if (Message.contains(TobeSearched)) {
            	 System.out.println("Search by Country by its 3 character alphanumericTestcase Passed and the value is :" + jp.get("RestResponse.messages[" + i + "]"));
